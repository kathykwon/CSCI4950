...
public class TopographyReader<E> {
	...
	private GraphMLImporter<String, E> impl;
	 ...
	 * @return the impl
	 */
	public GraphMLImporter<String, E> getImpl() {
		return impl;
	}
	 ...
	 */
	public void setImpl(GraphMLImporter<String, E> impl) {
		this.impl = impl;
	}
	...
	public static <E> void main(String[] args) throws ImportException, Exception {
		...
		*/
		...
		JGraph jgraph = new JGraph(new JGraphModelAdapter(topReader.getG()));
